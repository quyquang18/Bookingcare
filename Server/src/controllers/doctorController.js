...
let getProfileDoctorById = async (req, res) => {
  try {
    let response = await doctorSevices.getProfileDoctorById(req.query.doctorId);
    return res.status(200).json(response);
  } catch (error) {
    return res.status(200).json({
      errCode: -1,
...
let getListPatientForDoctor = async (req, res) => {
  try {
    let response = await doctorSevices.getListPatientForDoctor(req.query.doctorId, req.query.date);
    return res.status(200).json(response);
  } catch (error) {
    return res.status(200).json({
      errCode: -1,
...
let doctorConfirmSchedule = async (req, res) => {
  try {
    let response = await doctorSevices.doctorConfirmSchedule(req.body);
    return res.status(200).json(response);
  } catch (error) {
    return res.status(200).json({
      errCode: -1,
